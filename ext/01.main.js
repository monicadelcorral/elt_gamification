...
gameApp.getMedalsFromUser = function() {
    ...
    $.each(data.badges, function(i, badge) {
        ...
        var itemsView = Math.max(Math.min(levelsEarned.length, 5), 1);
        ...
        //var innerbody = '<div class="glide" data-perview="'+itemsView+'"><div class="glide__track" data-glide-el="track"><ul class="glide__slides">';

        var innerbody = '<div class="gam-medals-slider">';

        $.each(levelsEarned, function(x, level) {
            if (x % 5 === 0) { //TODO
            }
            //innerbody += '<li class="glide__slide">';
            innerbody += '<div class="gam-medals-slider__slide">';
            var prefix = i === 0 ? '%' : '';
